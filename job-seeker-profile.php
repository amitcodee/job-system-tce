        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="personalInfoForm" action="update-personal-info.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="name" class="form-label">
                                    ...
                                    <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Use your legal name as per certificates.">?</span>
                                </label>
                            ...
                            <div class="mb-3">
                                <label for="dob" class="form-label">
                                    ...
                                    <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Used for verification and eligibility.">?</span>
                                </label>
                            ...
                            <div class="mb-3">
                                <label for="father_name" class="form-label">
                                    ...
                                    <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Enter as per official documents.">?</span>
                                </label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="address" class="form-label">
                                    ...
                                    <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Current residential address.">?</span>
                                </label>
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label">
                                    <strong>Email:</strong>
                                    <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Email is locked to keep your account secure.">?</span>
                                </label>
                            ...
                            <div class="mb-3">
                                <label for="phone" class="form-label">
                                    <strong>Phone:</strong>
                                    <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Phone number is locked to keep your account secure.">?</span>
                                </label>
                                <input type="text" id="phone" name="phone" class="form-control" value="<?= htmlspecialchars($user['phone'] ?? ''); ?>" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="languages_known" class="form-label">
                                    <strong>Languages Known:</strong>
                                    <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Example: English, Hindi, Tamil.">?</span>
                                </label>
                    ...
                    <div class="mb-3">
                        <label for="profile_summary" class="form-label">
                            <strong>Profile Summary:</strong>
                            <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="Write 3–5 lines about your skills and goals.">?</span>
                        </label>
                    ...
                    <div class="mb-3">
                        <label for="resume" class="form-label">
                            ...
                            <span class="ms-1 text-muted" data-bs-toggle="tooltip" title="PDF only, max 5MB.">?</span>
                        </label>
